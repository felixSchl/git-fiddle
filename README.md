# git-fiddle (1) [![Build Status](https://travis-ci.com/felixSchl/git-fiddle.svg?token=xoiHuBog1EBjhZry4bxb&branch=master)](https://travis-ci.com/felixSchl/git-fiddle)
